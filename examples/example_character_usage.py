...
def main():
    ...
    try:
        ...
        print(f"  Found {len(results)} character(s) matching 'brave':")
        for char in results:
            print(f"    - {char.name}")
        ...
        print(f"\n📁 Check the project directory for character files: {project_dir}")
