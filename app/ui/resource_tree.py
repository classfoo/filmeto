    ...
    def init_ui(self):
        ...
        self.setStyleSheet("""
            ...
            QTreeWidget::branch:closed:has-children:has-siblings {
                border-image: none;
                image: url(:/qt-project.org/styles/commonstyle/images/branch_closed-1.png);
            }
            QTreeWidget::branch:open:has-children:!has-siblings,
            QTreeWidget::branch:open:has-children:has-siblings {
                border-image: none;
                image: url(:/qt-project.org/styles/commonstyle/images/branch_open-1.png);
            }
            QHeaderView::section {
        ...
        try:
            ...
            for entry in entries:
                ...
                if entry.is_dir():
                    ...
                    #item.setText(1, self._format_file_size(entry.stat().st_size))
