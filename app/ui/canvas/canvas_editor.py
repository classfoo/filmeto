...
from app.ui.canvas.canvas_tools import CanvasToolsWidget  # Import the new CanvasToolsWidget
...
class CanvasEditor(BaseWidget):
    ...
    def __init__(self, workspace: Workspace):
        ...
        try:
            ...
            # Initialize tools panel - now using CanvasToolsWidget
            self.tools_panel = CanvasToolsWidget(self.canvas_widget)
            ...
            # Add tools panel (top) and layers panel (bottom) to the left panel
