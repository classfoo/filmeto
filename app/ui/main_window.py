...
class MainWindowTopBar(BaseWidget):
    ...
    def __init__(self, window,workspace:Workspace):
        ...
        # self.resolution_combo.setObjectName("main_window_top_bar_resolution")
        # self.resolution_combo.setToolTip(tr("设置预览分辨率"))
        # # 添加常见的预览分辨率选项
        # self.resolution_combo.addItem("640x360 (16:9)", (640, 360))
        # self.resolution_combo.addItem("800x450 (16:9)", (800, 450))
        # self.resolution_combo.addItem("800x600 (4:3)", (800, 600))
        # self.resolution_combo.addItem("1024x576 (16:9)", (1024, 576))
        # self.resolution_combo.addItem("1280x720 (HD)", (1280, 720))
        # self.resolution_combo.setCurrentIndex(1)  # 默认选择第一个选项
