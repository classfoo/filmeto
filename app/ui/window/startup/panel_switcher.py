"""
Panel Switcher for Startup Window

This module implements a panel switcher similar to the one used in the edit window
...
class StartupWindowWorkspaceTopRightBar(BaseWidget):
    """
    Panel switcher for the startup window's right sidebar.

    Manages multiple tool panels and switches between them
    based on button clicks from StartupWindowRightBar. Uses lazy loading to instantiate
