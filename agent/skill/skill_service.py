    ...
    async def execute_skill_in_context(
        ...
        if skill.scripts:
            ...
            if llm_result.get("success") and llm_result.get("output_type") == "llm_generated":
                ...
                result_str = self._skill_chat._execute_skill_script(skill, updated_args, script_name, project)
                ...
                result_str = self._skill_chat._execute_skill_script(skill, args, script_name, project)
                # Convert the string result to a dictionary format for consistency
                result = {"success": True, "output": result_str, "message": result_str}
        else:
